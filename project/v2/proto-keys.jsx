  ...
  return (
    <div className="help-scrim" onMouseDown={onClose}>
      <div className="help" onMouseDown={(e) => e.stopPropagation()}>
        ...
        <div className="help-rels">
          <div className="help-coltitle">Die fünf Beziehungen</div>
          <div className="help-rels-grid">
            <span className="help-rel"><span className="reldot vor" /> Vorgänger <em>· woraus dieser hervorging</em></span>
            <span className="help-rel"><span className="reldot folge" /> Folgezettel <em>· führt den Gedanken fort</em></span>
            <span className="help-rel"><span className="reldot verzweig" /> Verzweigung <em>· ein eigener Nebenast</em></span>
            <span className="help-rel"><span className="reldot verweis" /> Verweis <em>· freier Querbezug</em></span>
            <span className="help-rel"><span className="reldot ki" /> Vermutung <em>· KI-Vorschlag, gestrichelt</em></span>
          </div>
        </div>
